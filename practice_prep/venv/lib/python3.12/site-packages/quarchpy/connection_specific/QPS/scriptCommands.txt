...
Command: $convert csv
Description: Converts a CSV file [.csv] to a QPS recording [.qps]
Version: 2
Arguments
Argument: from
...
Default value: NONE
Argument: to
Description: To .qps file
Index: 1
Type: STRING
Default value: NONE
Notes:
For a "to" file such as "c:\recordings\rec1\rec1.qps" the base directory "c:\recordings" must exist, but the newly created recording directory "c:\recordings\rec1" must not already exist as this will created as part of the conversion
...
$convert csv ~ Converts a CSV file [.csv] to a QPS recording [.qps]
