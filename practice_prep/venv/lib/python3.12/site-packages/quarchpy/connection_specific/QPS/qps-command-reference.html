...
<p>Copyright (c) Quarch Ltd</p><p>QPS v1.50.1-5e7318a-SNAPSHOT</p><p>Generated: 16 Jan 2026</p><p>This document lists the commands that can be sent to QPS over the TCP interface. By default
...
<li>
<a href="#convertcsv">$convert csv</a></li>
<li>
...
<hr/>
<div class="content-item"><h2><a name="convertcsv">$convert csv</a></h2><p class="version">Version 2</p><p>Converts a CSV file [.csv] to a QPS recording [.qps]</p><table><thead><tr><th>#</th><th>Argument</th><th>Type</th><th>Description</th></tr></thead><tbody><tr><td><code>1</code></td><td><code>from</code></td><td><code>STRING</code></td><td>From .csv file</td></tr><tr><td><code>2</code></td><td><code>to</code></td><td><code>STRING</code></td><td>To .qps file</td></tr></tbody></table><br/><p><span class="notes-title">Notes:&nbsp;</span>For a "to" file such as "c:\recordings\rec1\rec1.qps" the base directory "c:\recordings" must exist, but the newly created recording directory "c:\recordings\rec1" must not already exist as this will created as part of the conversion</p><p>All channels detected in the "from" file are converted</p><div class="examples-title">Examples</div><p><code>$convert csv from="c:\temp\rec1.csv" to="c:\recordings\rec1\rec.qps"</code></p><p class="backlink"><a href="#index">Back to index</a></p></div>
<hr/>
